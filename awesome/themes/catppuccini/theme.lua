...
local theme_path = "~/.config/awesome/themes/catppuccini/"
    --[[ fg = "#CDD6F4", ]]

--[[ theme.bg_focus      = "#27273a" -- subtle ]]
local colors = {
    bg = "#1E1E2E",
    fg = "#CBA6F7",
}
...
theme.bg_focus      = "#2d2d4d"
theme.bg_urgent     = "#fa2954"
theme.bg_minimize   = "#2e2e5b"
...
theme.border_normal = "#9961dd"
theme.border_focus  = "#CBA6F7"
theme.border_marked = "#fa2954"
--
--
...
-- theme.wallpaper = theme_path.."/background2.png"
-- theme.wallpaper = theme_path.."/iss.png"
theme.wallpaper = theme_path.."/tree.jpg"
